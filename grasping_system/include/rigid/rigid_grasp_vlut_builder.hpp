...
#include <rigid/rigid_grasp_model.hpp>
#include <rigid/rigid_grasp_vlut.hpp>
#include <voxel/grasp_voxel_model.hpp>
    ...
    for (const auto &seed : seeds) {
      ...
      for (const auto &kv : voxel_model.cells()) {
        ...
        const auto local_center =
          voxel_idx::VoxelIndexingSchema::indexToWorldCenter(cell.key, voxel_size);
        ...
        const auto world_index = voxel_idx::VoxelIndexingSchema::worldToIndex(
