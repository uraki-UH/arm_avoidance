...
const std::vector<ParameterSpec> kMatcherParameters{
  ...
  {"shape_tolerance", ParameterKind::Double},
  {"scale_tolerance", ParameterKind::Double},
  {"contradiction_limit", ParameterKind::Double},
};

const std::vector<ParameterSpec> kValidatorParameters{
  {"min_visible_ratio", ParameterKind::Double},
  {"recognition_threshold", ParameterKind::Double},
  {"confirmation_time_sec", ParameterKind::Double},
};
