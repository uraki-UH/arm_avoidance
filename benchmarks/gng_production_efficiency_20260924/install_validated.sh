...
output = Path('/ros2_ws/src/artifacts/gng_production_efficiency_20260924')
summary = json.loads((output / 'summary.json').read_text())
assert summary['comparison_frames'] == 1190
...
staged = installed.with_name('.libgng_cpu_efficiency_20260924.so')
