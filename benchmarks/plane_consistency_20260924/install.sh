...
case "$trial_backup" in runtime_before|scale_runtime_before|contact_runtime_before|fragment_runtime_before|direction_runtime_before|absorption_runtime_before) ;; *) exit 2 ;; esac
