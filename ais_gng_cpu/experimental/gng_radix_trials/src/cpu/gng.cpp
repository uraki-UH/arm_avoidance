...
void GNG::exec() {
    ...
    gng_efficiency_ms[0] = std::chrono::duration<double, std::milli>(t1 - t0).count();
    gng_efficiency_ms[1] = std::chrono::duration<double, std::milli>(t2 - t1).count();
    gng_efficiency_ms[2] = std::chrono::duration<double, std::milli>(t3 - t2).count();
    gng_efficiency_ms[3] = std::chrono::duration<double, std::milli>(t4 - t3).count();
    gng_efficiency_ms[4] = std::chrono::duration<double, std::milli>(t5 - t4).count();
    gng_efficiency_ms[5] = std::chrono::duration<double, std::milli>(t6 - t5).count();
    n1.finishMapDeltaFrame();
