...
class CUGNG {
   public:
    uint64_t trial_learning_num = 0;
    uint32_t trial_seed = 20260924U;
    bool enable_trial_last_representative = false;
    bool enable_trial_input_capture = false;
    vector<Vec3f> trial_inputs;
    int node_num = 0;
    int node_num_max = 0;
    vector<Node> nodes;
