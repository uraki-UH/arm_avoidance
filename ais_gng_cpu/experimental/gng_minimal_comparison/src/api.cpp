...
MY_API uint8_t gng_set_priority_input(const uint32_t *, uint32_t num_points, float) {
    return num_points == 0;
}

MY_API uint8_t gng_set_weighted_priority_input(const uint32_t *, const float *, uint32_t num_points, float) {
    return num_points == 0;
}

MY_API const gng_sampling_statistics *gng_get_comparison_statistics() {
    return &gng.n1.sampling_statistics;
}

MY_API const gng_sampling_statistics *gng_get_minimal_statistics() {
    return &gng.n1.sampling_statistics;
}
