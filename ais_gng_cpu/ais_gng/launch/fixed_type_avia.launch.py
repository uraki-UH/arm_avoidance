...
user_config_path = os.path.join(package_dir, "config", "lidar", "AVIA_config.json")
gng_config_path = PathJoinSubstitution([package_dir, 'config', 'gng', 'avia.yaml'])
...
def generate_launch_description():
    map2lidar_tf_node = Node(
        ...
        arguments=[
            ...
            'map', frame_id      # parent_frame, child_frame
        ]
    )
