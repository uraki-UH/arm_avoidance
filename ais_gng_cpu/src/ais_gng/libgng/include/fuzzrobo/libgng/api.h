 ...
 * @param[in] cluster_frames クラスタフレーム
 * @param[in] cluster_labels クラスタラベル
 * @param[in] size クラスタの数
 */
void gng_setInferredClusterLabels(const uint32_t *cluster_ids, const uint32_t *cluster_frames, const uint8_t *cluster_labels, const uint32_t size);
