...
#include "description/ode/ode_robot_builder.hpp"
#include "description/ode/ode_robot_sim.hpp"
#include "description/geometry_management.hpp"
...
int main(int argc, char **argv) {
  ...
  auto gng = std::make_unique<GrowingNeuralGas<Eigen::VectorXf, Eigen::Vector3f>>(
