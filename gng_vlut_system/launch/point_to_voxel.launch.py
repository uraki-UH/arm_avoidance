...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("max_reachability_y", default_value="0.4"),
        DeclareLaunchArgument("min_reachability_z", default_value="-0.2"),
        DeclareLaunchArgument("max_reachability_z", default_value="0.8"),
