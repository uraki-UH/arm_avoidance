...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("target_pose_array_topic", default_value="/grasp_pose_cands"),
        DeclareLaunchArgument("target_score_topic", default_value="/grasp_pose_cand_scores"),
